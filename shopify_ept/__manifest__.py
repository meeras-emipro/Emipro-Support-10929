{
    ...
    'version': '15.0.4.0.1',
    'category': 'Sales',
    'summary': 'Shopify Connector helps you in integrating and managing your Shopify store with Odoo by providing'
               ' the most useful features of Product and Order Synchronization. This solution is compatible with our other apps i.e. Amazon, ebay, magento, Inter Company Transfer, Shipstation',
    'license': 'OPL-1',
